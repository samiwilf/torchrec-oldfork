...
class InteractionArch(nn.Module):
    ...
    branch 2. Y and Z are of size BxF1xD and BxDxF2 respectively.
    ...
    def __init__(
        ...
        interaction_branch1: Optional[nn.Module] = None,
        interaction_branch2: Optional[nn.Module] = None,
    ) -> None:
        super().__init__()
    ...
    def forward(
        ...
        Returns:
            torch.Tensor: an output tensor of size B X (D + (F * F')).
        """
        if self.F <= 0:
...
class DLRM(nn.Module):
    ...
    * num_features: number of dense features
    ...
    def __init__(
        ...
        if interaction_branch1_layer_sizes:
            ...
            projected_dim_1 = interaction_branch1_layer_sizes[-1] // embedding_dim
            ...
            interaction_branch1 = None

        if interaction_branch2_layer_sizes:
            ...
            projected_dim_2 = interaction_branch2_layer_sizes[-1] // embedding_dim
        ...
        if interaction_branch1 or interaction_branch2:
